...
const ejercicios = ref([
  {
    ...
    video: "https://www.youtube.com/embed/ykJmrZ5v0Oo", // Video real de curl de bíceps
    series: 4,
    repeticiones: "10-12",
    descansoOriginal: 90,
    tiempoRestante: 90,
    estado: "inicio",
    intervalo: null,
    descripcion: "Constructor masivo para el bíceps braquial, ideal por la ergonomía del agarre."
  },
  {
    nombre: "Press Francés (Skull Crusher)",
    imagen: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=600&auto=format&fit=crop",
    video: "https://www.youtube.com/embed/BdqzYZmL2Bc", // Video real de press frances (skull crusher)
    series: 4,
    repeticiones: "10-12",
    descansoOriginal: 90,
    tiempoRestante: 90,
    estado: "inicio",
    intervalo: null,
    descripcion: "Enfocado en la cabeza larga del tríceps para máximo volumen."
  },
  {
    nombre: "Curl Inclinado con Mancuernas",
    imagen: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?q=80&w=600&auto=format&fit=crop",
    video: "https://www.youtube.com/embed/b4jOP-spQW8", // Video real de curl con mancuernas inclinado
    series: 3,
    repeticiones: "12-15",
    descansoOriginal: 60,
    tiempoRestante: 60,
    estado: "inicio",
    intervalo: null,
    descripcion: "Desarrolla el braquial anterior y los antebrazos dando grosor al brazo."
  },
  {
    nombre: "Extensión de Tríceps (Polea)",
    imagen: "https://images.unsplash.com/photo-1533681436303-34e262174151?q=80&w=600&auto=format&fit=crop",
    video: "https://www.youtube.com/embed/_gsUck-7M74", // Video real de extensiones de tríceps
    series: 4,
    repeticiones: "12-15",
    descansoOriginal: 60,
    tiempoRestante: 60,
    estado: "inicio",
    intervalo: null,
    descripcion: "Excelente para aislar el tríceps con tensión constante en todo el recorrido."
  }
])
  ...
  <div class="pantalla-gym">
    ...
    <header class="navbar-gym">
      ...
      <nav class="nav-links">
        ...
        <button class="nav-btn active">Brazos</button>
    ...
    <div class="text-center q-pt-md q-pb-lg mt-navbar">
      <h1 class="titulo-gym">ARM DAY</h1>
      <p class="subtitulo">Aislamiento y congestión para bíceps y tríceps</p>
    </div>
