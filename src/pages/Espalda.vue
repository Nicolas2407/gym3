...
const ejercicios = ref([
  {
    nombre: "Dominadas Prone",
    imagen: "https://images.unsplash.com/photo-1598971639058-aba3c3ef19a7?q=80&w=600&auto=format&fit=crop",
    video: "https://www.youtube.com/embed/UgKaDSA3uIg", // Video real de Dominadas de Howcast
    series: 4,
    repeticiones: "8-12",
    descansoOriginal: 90,
    tiempoRestante: 90,
    estado: "inicio",
    intervalo: null,
    descripcion: "Enfoque en el dorsal ancho y la estabilidad escapular."
  },
  {
    nombre: "Jalón al Pecho",
    imagen: "https://images.unsplash.com/photo-1605296867304-46d5465a25f1?q=80&w=600&auto=format&fit=crop",
    video: "https://www.youtube.com/embed/u3gQT2aMVaI", // Video real de Jalón al pecho de Howcast
    series: 4,
    repeticiones: "10-12",
    descansoOriginal: 60,
    tiempoRestante: 60,
    estado: "inicio",
    intervalo: null,
    descripcion: "Excelente ejercicio constructor de amplitud vertical."
  },
  {
    nombre: "Remo inclinado",
    imagen: "https://images.unsplash.com/photo-1434608519344-49d77a699e1d?q=80&w=600&auto=format&fit=crop",
    video: "https://www.youtube.com/embed/hZSEp_rSDgs", // Video real de Remo inclinado de Howcast
    series: 4,
    repeticiones: "8-10",
    descansoOriginal: 90,
    tiempoRestante: 90,
    estado: "inicio",
    intervalo: null,
    descripcion: "Desarrolla el grosor de la espalda media y trapecios."
  },
  {
    ...
    video: "https://www.youtube.com/embed/NaU8mlULPmY", // Rutina de remo/espalda media de Howcast
    series: 3,
    repeticiones: "10-12",
    descansoOriginal: 75,
    tiempoRestante: 75,
    estado: "inicio",
    intervalo: null,
    descripcion: "Trabajo concentrado en la zona media de la espalda y romboides."
  },
  {
    nombre: "Pull-Over con Polea Alta",
    imagen: "https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?q=80&w=600&auto=format&fit=crop",
    video: "https://www.youtube.com/embed/xLqf-9SyyXc", // Video real de pullovers
    series: 3,
    repeticiones: "12-15",
    descansoOriginal: 60,
    tiempoRestante: 60,
    estado: "inicio",
    intervalo: null,
    descripcion: "Aislamiento excelente del dorsal ancho manteniendo tensión constante."
  },
  {
    ...
    video: "https://www.youtube.com/embed/DNJya2CBQJ8", // Video real de peso muerto/erectores de Howcast
    series: 3,
    repeticiones: "15",
    descansoOriginal: 60,
    tiempoRestante: 60,
    estado: "inicio",
    intervalo: null,
    descripcion: "Fortalecimiento de la zona baja de la espalda y erectores espinales."
  }
])
  ...
  if (ejercicio.estado === 'inicio') {
    ...
    ejercicio.intervalo = setInterval(() => {
      if (ejercicio.tiempoRestante > 0) {
        ...
        alert(`¡Descanso terminado para ${ejercicio.nombre}! Prepárate para la siguiente serie.`)
      }
    }, 1000)
  }
}
  ...
  <div class="pantalla-gym">
    ...
    <header class="navbar-gym">
      ...
      <nav class="nav-links">
        ...
        <button class="nav-btn active">Espalda</button>
        <button class="nav-btn" @click="router.push('/brazos')">Brazos</button>
        <button class="nav-btn" @click="router.push('/piernas')">Piernas</button>
        <button class="nav-btn" @click="router.push('/pecho')">Pecho</button>
      </nav>
    </header>
    
    <div class="text-center q-pt-md q-pb-lg mt-navbar">
      <h1 class="titulo-gym">BACK DAY</h1>
      <p class="subtitulo">Hipertrofia y fuerza de la cadena posterior</p>
    </div>
