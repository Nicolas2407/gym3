...
const ejercicios = ref([
  {
    ...
    estado: "inicio",
    intervalo: null,
    descripcion: "El movimiento base para desarrollar la masa general del pectoral."
  },
  {
    ...
    estado: "inicio",
    intervalo: null,
    descripcion: "Enfocado en el haz clavicular (pecho alto). Permite mayor rango de movimiento."
  },
  {
    ...
    estado: "inicio",
    intervalo: null,
    descripcion: "Excelente aislamiento para concentrar el trabajo muscular y bombear sangre."
  },
  {
    ...
    estado: "inicio",
    intervalo: null,
    descripcion: "Trabajo de congestión final. Mantén la contracción un segundo en el centro."
  }
])
  ...
  if (ejercicio.estado === 'inicio') {
    ...
    ejercicio.intervalo = setInterval(() => {
      if (ejercicio.tiempoRestante > 0) {
        ...
        alert(`¡Descanso terminado para ${ejercicio.nombre}! A romperla.`)
      }
    }, 1000)
  }
}
  ...
  <div class="pantalla-gym">
    ...
    <header class="navbar-gym">
      ...
      <nav class="nav-links">
        ...
        <button class="nav-btn active">Pecho</button>
      </nav>
    </header>
    
    <div class="text-center q-pt-md q-pb-lg mt-navbar">
      <h1 class="titulo-gym">CHEST DAY</h1>
      <p class="subtitulo">Volumen y grosor para la cadena anterior</p>
    </div>
